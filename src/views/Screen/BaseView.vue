<template>
  <div class="base-view" :class="{ 'laser-pen': laserPen }">
    ...
    <div class="tools-left">
      <div class="page-num-btn page-bg">
        <IconLeft
          size="25"
          class="page-btn"
          theme="filled"
    ...
    <div class="tools-left" style="right: 8px; left: auto">
      <div class="page-num-btn page-bg">
        <IconLeft
          size="25"
          class="page-btn"
...
const contextmenus = (): ContextmenuItem[] => {
  return [
    ...
    },
    {
      ...
      handler: () =>
        (bottomThumbnailsVisible.value = !bottomThumbnailsVisible.value),
    },
    {
      text: "画笔工具",
...
const onClose = () => {
  exitScreening();
  window.parent.postMessage({ type: "close_course" }, "*");
};
</script>
